...
export const metadata: Metadata = {
  ...
  description:
    "30+ free and low-cost AI tools, organized by what you actually need to get done. Built for small business owners. Permanent access link, updated quarterly. Yours free.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      '30+ AI tools curated for small business owners. Organized by use case. Permanent access link, updated quarterly. Free.',
